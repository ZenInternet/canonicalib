...
namespace Zen.CanonicaLib.UI.Services
{
    public class DefaultDiscoveryService : IDiscoveryService
    {
        ...
        {
            // Collect all endpoint methods from parent interfaces first.
            // Interface inheritance doesn't surface attributes via inherit:true,
            ...
            // Now check the declaring type's own methods.
            var result = new List<MethodInfo>();
            var ownMethods = controllerDefinition.GetMethods();
