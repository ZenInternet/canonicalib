...
namespace Zen.CanonicaLib.UI.Extensions
{
    internal static class MethodInfoExtensions
    {
        ...
        /// parent interfaces if the method itself doesn't have one. This handles
        /// the case where a child interface uses <c>new</c> to redeclare a method
        /// (e.g. to add parameter-level attributes) without repeating the endpoint attribute.
        /// </summary>
